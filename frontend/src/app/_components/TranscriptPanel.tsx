...
export function TranscriptPanel({
  ...
  return (
    <div className="w-full min-h-0 flex-1 border-r border-gray-200 bg-white flex flex-col overflow-hidden">
      {/* Title stays outside the transcript scroller. */}
      <div className="shrink-0 bg-white p-4 border-gray-200">
              ...
              <ButtonGroup>
                {transcripts?.length > 0 && (
                  <Button
                    ...
                    title={t('actions.copyTranscript')}
                  >
                    <Copy />
      ...
      <div className="flex flex-1 min-h-0 justify-center">
        <div className="w-2/3 max-w-[750px] min-h-0">
