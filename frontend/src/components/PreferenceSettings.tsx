...
import { DisplayLanguageSettings } from "./DisplayLanguageSettings"
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6 shadow-sm">
        <div className="flex items-center justify-between">
          <div>
            <h3 className="flex items-center gap-1 text-base font-semibold text-gray-900">{t("preferences.notificationsTitle")}<HelpHint>{t("preferences.notificationsDescription")}</HelpHint></h3>
          </div>
          <Switch
            checked={notificationsEnabledValue}
            onCheckedChange={setNotificationsEnabled}
            aria-label={t("preferences.notificationsTitle")}
          />
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6 shadow-sm">
        <h3 className="flex items-center gap-1 text-base font-semibold text-gray-900 mb-4">{t("preferences.storageTitle")}<HelpHint><p>{t("preferences.storageDescription")}</p><p>{t("preferences.storageNote")}</p></HelpHint></h3>
