...
export const BlockComponent: React.FC<BlockProps> = ({
  ...
  const commands: CommandOption[] = [
    { id: 'text', label: t('labels.text'), type: 'text', icon: 'T', description: t('descriptions.justStartWritingWithPlainText') },
    { id: 'bullet', label: t('labels.bulletList'), type: 'bullet', icon: '•', description: t('descriptions.createABulletedList') },
    { id: 'h1', label: t('labels.heading1'), type: 'heading1', icon: 'H1', description: t('descriptions.bigSectionHeading') },
    { id: 'h2', label: t('labels.heading2'), type: 'heading2', icon: 'H2', description: t('descriptions.mediumSectionHeading') },
  ];
    ...
    >
      ...
      <div className="relative flex-1 py-0.5 px-1">
        <textarea
          ...
          `}
          placeholder={t('placeholders.typeForCommands')}
        />
