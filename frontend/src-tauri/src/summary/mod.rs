...
pub mod template_commands_v2;
pub(crate) mod template_snapshot;
pub mod templates;

// Re-export Tauri commands (with their generated __cmd__ variants)
pub use commands::{
    __cmd__api_begin_summary_measurement, __cmd__api_cancel_summary,
    __cmd__api_detect_transcript_summary_language, __cmd__api_finish_summary_measurement,
    ...
    __cmd__api_record_summary_frontend_stage, __cmd__api_record_summary_page_completion,
    __cmd__api_save_meeting_detected_summary_language, __cmd__api_save_meeting_summary,
    __cmd__api_save_meeting_summary_language, __tauri_command_name_api_begin_summary_measurement,
    __tauri_command_name_api_cancel_summary,
    __tauri_command_name_api_detect_transcript_summary_language,
    __tauri_command_name_api_finish_summary_measurement,
    ...
    __tauri_command_name_api_record_summary_frontend_stage,
    __tauri_command_name_api_record_summary_page_completion,
    __tauri_command_name_api_save_meeting_detected_summary_language,
    __tauri_command_name_api_save_meeting_summary,
    __tauri_command_name_api_save_meeting_summary_language, api_begin_summary_measurement,
    api_cancel_summary, api_detect_transcript_summary_language, api_finish_summary_measurement,
    api_get_meeting_detected_summary_language, api_get_meeting_summary_language, api_get_summary,
    api_process_transcript, api_record_summary_frontend_stage, api_record_summary_page_completion,
