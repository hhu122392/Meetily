...
// RNNoise is enabled for the live microphone path. `NoiseSuppressionProcessor`
// converts CPAL's normalized samples to RNNoise's 16-bit PCM float scale and
// converts the result back before it reaches the mixer.
