...
impl<R: Runtime> NotificationManager<R> {
    ...
    pub async fn show_recording_started(&self, meeting_name: Option<String>) -> Result<()> {
        ...
        let notification = Notification::recording_started(
            crate::i18n::current_locale(&self.app_handle),
            meeting_name,
        );
    ...
    pub async fn show_recording_stopped(&self) -> Result<()> {
        ...
        let notification =
            Notification::recording_stopped(crate::i18n::current_locale(&self.app_handle));
        self.show_notification(notification).await
    }
    ...
    pub async fn show_recording_paused(&self) -> Result<()> {
        ...
        let notification =
            Notification::recording_paused(crate::i18n::current_locale(&self.app_handle));
        self.show_notification(notification).await
    }
    ...
    pub async fn show_recording_resumed(&self) -> Result<()> {
        ...
        let notification =
            Notification::recording_resumed(crate::i18n::current_locale(&self.app_handle));
        self.show_notification(notification).await
    }
    ...
    pub async fn show_meeting_reminder(
        ...
        let notification = Notification::meeting_reminder(
            crate::i18n::current_locale(&self.app_handle),
            minutes_until,
            meeting_title,
        );
    ...
    pub async fn show_system_error(&self, error: String) -> Result<()> {
        ...
        // Preserve the raw diagnostic in logs only. The OS notification uses
        // locale resources and never echoes paths, tokens, or stack details.
        log_error!("System error notification requested: {}", error);
        let notification =
            Notification::system_error(crate::i18n::current_locale(&self.app_handle));
        self.show_notification(notification).await
    }
    ...
    pub async fn show_test_notification(&self) -> Result<()> {
        let notification =
            Notification::test_notification(crate::i18n::current_locale(&self.app_handle));
        self.system_handler.show_notification(notification).await
    }
    ...
    async fn should_show_notification(&self, notification: &Notification) -> bool {
        ...
        match &notification.notification_type {
            ...
            NotificationType::SystemError => settings.notification_preferences.show_system_errors,
