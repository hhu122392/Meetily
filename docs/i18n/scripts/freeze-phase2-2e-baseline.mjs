...
const batch = manifest.batches["2E"];
...
const output = {
  phase: "15.5-stage-2E-import-retranscribe-recovery",
...
const outputPath = path.join(root, "docs/i18n/audit/phase-2-react/2E/pre-edit-baseline.json");
